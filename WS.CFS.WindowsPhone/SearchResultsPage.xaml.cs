    ...
    public sealed partial class SearchResultsPage : Page
    {
        ...
        private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (feedbackDataSource != null)
                this.defaultViewModel["Results"] = feedbackDataSource.Feedbacks
                                                    .Where(x =>
                                                         string.Concat(x.Id.ToLower(), x.Title.ToLower()).Contains(queryText.ToLower()))
                                                    .ToList();
        ...
        {
            var itemId = ((Feedback)e.ClickedItem).Id;
